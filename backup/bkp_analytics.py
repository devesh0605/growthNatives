...
# credentials = ServiceAccountCredentials.from_json_keyfile_name('variables/client_secrets.json',
...
#         'reportRequests': [
#             {
#                 'viewId': '240457500',  # Add View ID from GA
...
# # growth-native-analytics@growth-natives-testing.iam.gserviceaccount.com
